<%@ Page Title="About Us" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="about_us.aspx.cs" Inherits="_1_Blog.about_us" %>

<asp:Content ID="Content1" ContentPlaceHolderID="src" runat="server">
    <script>
        $(document).ready(function () {
            $("nav ul li a[href='about_us.aspx']").addClass("active disabled");
        });
    </script>
</asp:Content>
